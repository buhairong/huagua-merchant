	...
	methods: {
		...
		async savePlan() {
			...
			if (res.code == 0) {
				...
				uni.navigateTo({
					url: `/pages/plan/createSuccess?id=${res.data.id}&type=1&imgUrl=${this.productEntity.imageUrl}&brandName=${this.carProductInfo.brandName}&carType=${this.carProductInfo.carType}&carTypeYear=${this.carProductInfo.carTypeYear}&carTypeYearProduct=${this.carProductInfo.carTypeYearProduct}`
				})
			} else {
				uni.showToast({
					title: '保存失败',
		...
		async updatePlan() {
			...
			if (res.code == 0) {
				...
				uni.navigateTo({
					url: `/pages/plan/createSuccess?id=${this.createData.id}&type=1&imgUrl=${this.productEntity.imageUrl}&brandName=${this.carProductInfo.brandName}&carType=${this.carProductInfo.carType}&carTypeYear=${this.carProductInfo.carTypeYear}&carTypeYearProduct=${this.carProductInfo.carTypeYearProduct}`
				})
			} else {
				uni.showToast({
					title: '修改失败',
