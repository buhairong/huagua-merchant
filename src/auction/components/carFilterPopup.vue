		...
		goDetailPage() {
			...
			if(this.workType == 1) {
				...
				if (this.type == 1) {
					...
					uni.navigateTo({
						url: `/pages/car/addOldCar?brandId=${this.selectBrand.id}&brandName=${this.selectBrand.brandName}&carTypeId=${this.selectCarType.carTypeId}&carType=${this.selectCarType.carType}&carTypeYearId=${this.selectCarTypeYear.carTypeYearId}&carTypeYear=${this.selectCarTypeYear.carTypeYear}&carTypeYearProductId=${this.selectCarTypeYearProduct.id}&carTypeYearProduct=${this.selectCarTypeYearProduct.carTypeYearProduct}&imgUrl=${this.selectCarTypeYearProduct.imageUrl}&businessType=2`
					})
				}
			}
		},
